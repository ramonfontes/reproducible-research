...
file1 = 'OVS-LinearTopo-benchmark.txt'
file2 = 'User-LinearTopo-benchmark.txt'
file3 = 'OVS-SingleTopo-benchmark.txt'
file4 = 'User-SingleTopo-benchmark.txt'
file5 = 'icmp-OVS-LinearTopo-benchmark.txt'
file6 = 'icmp-User-LinearTopo-benchmark.txt'
file7 = 'icmp-OVS-SingleTopo-benchmark.txt'
file8 = 'icmp-User-SingleTopo-benchmark.txt'
